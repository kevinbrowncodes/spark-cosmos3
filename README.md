...
It implements the
[Flow Gateway Protocol](https://github.com/kevinbrowncodes/flow/blob/v0.2.1/protocol/PROTOCOL.md)
...
**`FLOW_VERSION`** (`.env`, default `v0.2.1`) pins both the `flow-protocol`
